<?php
/**
 * Admin View - Scheduling Conditions
 */
...
<head>
    ...
    <title>Admin - เงื่อนไขการจัดเวร</title>
...
<body>
    <div class="container">
        ...
        <nav>
            ...
            <a href="conditions.php" class="active">📜 เงื่อนไข</a>
        ...
        <div class="content">
            ...
            <?php require __DIR__ . '/../views/conditions.php'; ?>
        </div>
    </div>
</body>
